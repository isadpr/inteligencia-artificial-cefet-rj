...
class CornersProblem(search.SearchProblem):
    ...
    def getNextState(self, state, action):
        ...
        return ((nextx, nexty), tuple(new_visited_corners))
...
def cornersHeuristic(state, problem):
    ...
    start_state, visited_corners = state
    ...
    while unvisited_corners:
        distances = [util.manhattanDistance(start_state, corner) for corner in unvisited_corners]
        min_distance = min(distances)

        total_distance += min_distance

        closest_corner = unvisited_corners[distances.index(min_distance)]
        start_state = closest_corner
...
def foodHeuristic(state, problem):
    ...
    def calculateMazeDistance(start, end):
        try:
    ...
    for food in foodGrid.asList():
        distances.append(calculateMazeDistance(position, food))
        for tofood in foodGrid.asList():
            distances_food.append(calculateMazeDistance(food, tofood))
